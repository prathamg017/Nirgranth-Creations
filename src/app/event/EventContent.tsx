...
const stats = [
  { value: 50, label: "Big Event Management", suffix: "+" },
...
const testimonials = [
  {
    name: "Dr. Manish Jain",
    role: "President, Corporate Excellence Forum",
    quote: "Nirgranth Creations transformed our annual summit into a global-scale experience. Their attention to lighting and atmosphere is unmatched.",
    img: "https://i.pinimg.com/736x/d5/25/72/d52572a07b6166ce41412dea2fe3768e.jpg",
  },
  {
    name: "Sanjay Mehta",
    role: "Director, Heritage Gems",
    quote: "The award ceremony was executed with absolute precision. Every guest felt the luxury and scale of the event from the moment they entered.",
    img: "https://i.pinimg.com/736x/ee/83/b3/ee83b3b8e83b9715c9d905cb9e53c4f0.jpg",
  },
  {
    name: "Rajeshwari Shah",
    role: "Cultural Program Director",
    quote: "Managing a spiritual concert requires deep sensitivity. Nirgranth handled our Ratnatray event with perfect grace and modern vision.",
...
export default function EventManagementPage() {
  return (
    <main className="text-gray-900 font-sans overflow-hidden">
      ...
      {/* CONTACT FORM SECTION - Redirected */}
      <section
        id="contact"
